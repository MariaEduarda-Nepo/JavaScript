function verificarBrinde() {
    ...
    if (pizza1 === "grande" && pizza2 === "grande") {
        resultado.textContent = "Parabéns! Você ganhou um refrigerante de 2 litros.";
    } else if ((pizza1 === "media" && pizza2 === "pequena") || (pizza1 === "pequena" && pizza2 === "media")) {
        resultado.textContent = "Parabéns! Você ganhou uma porção de pão de alho.";
    } else {
        resultado.textContent = "Você não ganhou nenhum brinde.";
    }
}